...
if not firebase_admin._apps:
    ...
    firebase_admin.initialize_app(cred, {
        "storageBucket": "bright-ideas-verify-technician.firebasestorage.app"  # <-- Use your console's actual bucket name
    })
